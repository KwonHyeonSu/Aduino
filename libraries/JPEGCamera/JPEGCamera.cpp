...
int JPEGCamera::readData(char * response, int address)
{
	...
	for(int i=0; i<8; i++)Serial2.print(READ_DATA[i]);
	Serial2.print((byte)(address>>8));
	Serial2.print((byte)address);
	Serial2.print((byte)0x00);
	Serial2.print((byte)0x00);
	Serial2.print((byte)(read_size>>8));
	Serial2.print((byte)read_size);
	Serial2.print((byte)0x00);
	Serial2.print((byte)0x0A);	
