...
//***************************************************************
	...
	{	
		...
		float ganancia=5.0;
		float Vcc=3.3;
		float RefTension=2.4996;	// 2.4979;	// 3.0; // Voltage Reference of Wheatstone bridge.
		float Ra=4624.0;	// 4495.0;	// 4700.0; //Wheatstone bridge resistance.
		float Rc=4566.0; 	// 4702.0;	// 4700.0; //Wheatstone bridge resistance.
		float Rb=817.6; 	// 818.2;	// 821.0; //Wheatstone bridge resistance.
	...
	float eHealthClass::getSkinConductance(void)
	{
		...
		conductance = 2*((voltage - 0.499) / 100000);
